    ...
    <div style={{ fontFamily: FONT }} className="space-y-6 text-xs animate-fadeIn">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Private Sealed Bids · Simple Eligibility Check · Secure Proof of Submission
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="inline-flex p-1 rounded-full bg-[#F4F4F5] border border-gray-200/90 gap-1 text-xs">
        <button
          ...
          className={`px-4 py-1.5 rounded-full font-semibold transition-[color,background-color,box-shadow] duration-150 ease-out flex items-center gap-2 cursor-pointer select-none ${activeTab === 'available'
        ...
        <button
          ...
          className={`px-4 py-1.5 rounded-full font-semibold transition-[color,background-color,box-shadow] duration-150 ease-out flex items-center gap-2 cursor-pointer select-none ${activeTab === 'bids'
              ? 'bg-white text-gray-900 shadow-xs'
              : 'text-gray-600 hover:text-gray-900 hover:bg-white/60'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-1.5 rounded-full font-semibold transition-[color,background-color,box-shadow] duration-150 ease-out flex items-center gap-2 cursor-pointer select-none ${activeTab === 'profile'
              ? 'bg-white text-gray-900 shadow-xs'
              : 'text-gray-600 hover:text-gray-900 hover:bg-white/60'
            }`}
        >
          ...
          <span>Company Profile & Documents</span>
        </button>
      </div>
                  ...
                  >
                    <div className="space-y-2.5">
                      ...
                      <div className="p-3 rounded-xl bg-[#FBFBFD] border border-gray-200 flex justify-between items-center text-xs">
                        ...
                        <span
                          className={`font-semibold ${isClosed ? 'text-rose-600' : 'text-amber-700'
                            }`}
                        >
                          {countdown}
                        </span>
                    ...
                    <div className="pt-3 border-t border-gray-100 flex justify-between items-center gap-2">
                      ...
                      <button
                        ...
                        disabled={isClosed}
                        className={`px-4 py-1.5 rounded-full text-xs font-medium flex items-center gap-1.5 shadow-xs transition-colors cursor-pointer ${isClosed
                ...
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-gray-200 bg-[#F9FAFB] text-gray-500 text-[10px]">
                      ...
                      <th className="py-3 px-3 font-bold uppercase">Submission Time</th>
                      <th className="py-3 px-3 font-bold uppercase">Bid Amount</th>
                      <th className="py-3 px-3 font-bold uppercase">Status</th>
                      <th className="py-3 px-3.5 font-bold uppercase text-right">Receipt</th>
                    </tr>
                  </thead>
                      ...
                      myBids.map((b) => (
                        <tr key={b.id} className="hover:bg-gray-50/80 transition-colors">
                          ...
                          <td className="py-3 px-3">
                            <span
                              className={`px-2.5 py-0.5 rounded-full text-[10px] font-semibold border ${b.status === 'awarded'
                                  ? 'bg-emerald-50 text-emerald-700 border-emerald-200'
                                  : 'bg-blue-50 text-blue-700 border-blue-200'
                                }`}
                            >
                              {b.status === 'awarded' ? 'CONTRACT AWARDED' : 'LOCKED & SAFE'}
                            </span>
                          </td>
          ...
          <div className="relative w-full max-w-md bg-white border border-gray-200 rounded-2xl p-6 shadow-2xl space-y-4 text-xs my-auto">
            <div className="flex justify-between items-center border-b border-gray-100 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-blue-600 font-medium">Verified Safe Submission</span>
                </div>
              </div>
              <button
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="p-3 rounded-xl bg-[#F9FAFB] border border-gray-200 space-y-1">
                <span className="text-[10px] text-gray-400 font-semibold uppercase block">Digital Fingerprint (Unique Bid ID)</span>
            ...
            <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-xs text-emerald-900 space-y-1">
              <span className="font-bold block">✓ SAFELY LOCKED & SECRET</span>
              <p className="opacity-90 leading-relaxed text-[11px]">
                Your bid is safely locked. No government officer or competitor can see your price until the official deadline passes.
              </p>
            </div>
